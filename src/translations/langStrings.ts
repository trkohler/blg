export const langStrings = {
  ...
  author_box_about_the_author: {
    en: `ABOUT THE AUTHOR`,
    ru: `ОБ АВТОРЕ`,
    uk: `ПРО АВТОРА`,
  },
  author_box_text: {
    en: `Troy Köhler is Software Engineer living in Berlin, Germany with ~6 years
        of experience working in technology industry. He used to work in one of
        the biggest e-commerce product in Ukraine, and now works at Zalando
        which has more than 7 millions paying customers. He focuses his study
        and expertise on Rust language, complex backend systems, product
        development and engineering platforms.`,
    ru: `Трой Кёлер - программист, живущий в Берлине, Германия. 
        У него более 6 лет опыта работы в IT. Ранее он работал в одном из крупнейших интернет-магазинов Украины, а сейчас работает в Zalando. Он специализируется на языке программирования Rust, сложных бекенд системах, разработке продуктов и инженерных платформах.`,
    uk: `Трой Кёлер - програміст, який живе в Берліні, Німеччина.
        У нього більше 6 років досвіду роботи в IT. Раніше він працював в одному з найбільших інтернет-магазинів України, а зараз працює в Zalando. Він спеціалізується на мові програмування Rust, складних бекенд системах, розробці продуктів і інженерних платформах.`,
  },
};
